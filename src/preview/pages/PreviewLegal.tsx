    ...
    <div className="preview-market">
      ...
      <article className="preview-doc">
        ...
        <div className="preview-tiles">
          ...
          <article className="preview-tile">
            <h3>Google</h3>
            <p>Analytics and advertising measurement (Google Analytics 4). Google receives the events above and the analytics client id. A completed purchase can also be sent from our server with that client id. See <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">policies.google.com/privacy</a>.</p>
          </article>
          <article className="preview-tile">
            <h3>Meta</h3>
